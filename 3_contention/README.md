...
> **Status** — single-line contention **T=1/2/4/8**, **8/8 gate-clean** (pin+overlap) · paired, 1M iters · regenerated 2026-06-10.
...
*Auto-generated by `lib/parse_group.py` from the locked `out/` sweep on 2026-06-10. **Numbers** → `processed/3_contention_*.csv` (+ per-treatment `<t>/out/bench.csv`). **Method** → [`../METHODOLOGY.md`](../METHODOLOGY.md). **Up** → [`../README.md`](../README.md).*
